# TLS Bootstrapping Worker Node 02
...
# Step 1 Create the Boostrap Token to be used by Nodes(Kubelets) to invoke Certificate API on Master-1
...
## Step 2 Authorize workers(kubelets) to create CSR on Master-1
...
## Step 3 Authorize workers(kubelets) to Auto Renew Certificates on expiration on master 1
